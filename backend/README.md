...
## Project Structure
    ...
    ├── testapiautostorybo_112036  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_112036`
...
2. Clone this repo and `cd testapiautostorybo_112036`
